...
public class Customer {
	...
	public Customer(String customer_number,String FIRSTNAME ,String  middlename,String lastname,String CUSTOMER_CITY,int CUSTOMER_CONTACT_NO,String occupation,LocalDate CUSTOMER_DATE_OF_BIRTH ) {
		super();
